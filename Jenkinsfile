node {
 ...
 stage('Build'){
    ...
    httpRequest authentication: 'harbor_credentials', httpMode: 'HEAD', ignoreSslErrors: true, responseHandle: {isProjectPresentOnRegistry=true}, url: 'https://harbor.bj-cloud.xyz/api/projects?project_name='+project
